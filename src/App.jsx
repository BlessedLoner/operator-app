...
import ManualOutreach from "./Pages/ManualOutreach"; // ✅ ADD THIS
...
function DashboardRouter() {
  ...
  // Outreach operators get their own dashboard (or redirect to manual outreach)
  if (operatorType === "outreach") {
    return <ManualOutreach />;
  }
  ...
  return (
    ...
    >
      <Routes>
        ...
        {/* ✅ Manual Outreach - Direct access (for outreach operators) */}
